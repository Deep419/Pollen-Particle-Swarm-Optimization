 ...
 *
 * score_func_emxutil.h
 *
 * Code generation for function 'score_func_emxutil'
 *
 */

#ifndef SCORE_FUNC_EMXUTIL_H
#define SCORE_FUNC_EMXUTIL_H
...
/* End of code generation (score_func_emxutil.h) */
